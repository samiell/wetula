...
module.exports = (sequelize, DataTypes) => {
    ...
    User.findByToken = function (token) {
        return new Promise(function (resolve, reject) {
            try {
                ...
                const bytes = cryptojs.AES.decrypt(decodedJWT.token, keys.cryptojsSK);
    ...
    User.prototype.toPublicJSON = function () {
        return _.pick(this.toJSON(), 'email', 'createdAt', 'updatedAt');
    };
    ...
    User.prototype.generateToken = function (type) {
        ...
        try {
            ...
            const encryptedData = cryptojs.AES.encrypt(stringData, keys.cryptojsSK).toString();
